...
<div class="siteseo-option">
	...
	<?php
	echo wp_kses(siteseo_feature_title(null), ['h1' => true, 'input' => ['type' => true, 'name' => true, 'id' => true, 'class' => true, 'data-*' => true], 'label' => ['for' => true], 'span' => ['id' => true, 'class' => true], 'div' => ['id' => true, 'class' => true]]);
			...
			<div class="postbox section-tool">
				...
				<div class="inside">
					...
					<form method="post" enctype="multipart/form-data">
						...
						<?php siteseo_submit_button(__('Reset notices', 'siteseo'), true, 'btn btnSecondary'); ?>
					</form>
				</div><!-- .inside -->
			</div><!-- .postbox -->
			...
			<div class="postbox section-tool">
				<div class="inside">
					...
					<form method="post" enctype="multipart/form-data">
						...
						<?php siteseo_submit_button(__('Reset settings', 'siteseo'), true, 'btn btnSecondary is-deletable'); ?>
					</form>
				</div><!-- .inside -->
			</div><!-- .postbox -->
		</div>
