...
function siteseo_title_home_tab(&$options){
...
function siteseo_title_post_tab(&$options){
...
function siteseo_title_archive_tab(&$options){
...
function siteseo_title_tax_tab(&$options){
	$anchor_html = '';
	$html = '';
...
function siteseo_advanced_tab(&$options){
...
function siteseo_save_title_settings(){
	...
	if(!empty($_POST['siteseo_titles_option_name'])){
		$title_options = map_deep($_POST['siteseo_titles_option_name'], 'wp_unslash');
		$title_options = map_deep($title_options, 'sanitize_text_field');
	}
