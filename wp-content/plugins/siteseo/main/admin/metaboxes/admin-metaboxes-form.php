					...
					<div id="tabs-1">
						...
						<div class="box-left">
							...
							<div class="wrap-tags">
								...
								<?php echo wp_kses(siteseo_render_dyn_variables('tag-title'), $metabox_tag_drop_kses); ?>
							</div>
							<p>
							...
							<div class="wrap-tags">
								...
								<?php }
									echo wp_kses(siteseo_render_dyn_variables('tag-description'), $metabox_tag_drop_kses);
								?>
							</div>
						</div>
						...
						<div class="box-right">
							<div class="facebook-snippet-preview">
								...
								<div class="facebook-snippet-box">
									...
									<div class="snippet-fb-img"><img src="<?php echo esc_url(SITESEO_DIR_URL . '/assets/img/social-placeholder.png');?>" width="524" height="274" alt=""
						...
						<div class="box-right">
							<div class="twitter-snippet-preview">
								...
								<div class="twitter-snippet-box">
									...
									<div class="snippet-twitter-img"><img src="<?php echo esc_url(SITESEO_DIR_URL . '/assets/img/social-placeholder.png');?>" width="524" height="274" alt=""
