...
settings_fields('siteseo_social_option_group'); ?>
	...
	<div id="siteseo-tabs" class="wrap">
		<?php
			echo wp_kses(siteseo_feature_title('social'), ['h1' => true, 'input' => ['type' => true, 'name' => true, 'id' => true, 'class' => true, 'data-*' => true], 'label' => ['for' => true], 'span' => ['id' => true, 'class' => true], 'div' => ['id' => true, 'class' => true]]);
			$current_tab = '';
